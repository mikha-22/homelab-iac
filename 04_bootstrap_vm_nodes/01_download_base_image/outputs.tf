...
output "troubleshooting" {
  ...
  value = {
    ...
    storage_status   = "ssh root@pve1.local 'pvesm status -storage cluster-shared-nfs'"
    cloud_init_files = "ssh root@pve1.local 'ls -la /var/lib/vz/snippets/ | grep base-template'"
  }
}
